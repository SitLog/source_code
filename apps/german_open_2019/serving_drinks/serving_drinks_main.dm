...
[
		...
		arcs ==> [
			 empty : [
				 ...
				 say('I will first go to the bar')
			        ...
			        => goto_bar_and_detect_drinks
		         ]
	],
	
	[% Go to bar and detect objects  
		id ==> goto_bar_and_detect_drinks,	
		type ==> recursive,
		embedded_dm ==> goto_bar_and_detect_drinks(FinalStatus),
		arcs ==> [
			 ...
			 error : empty => goto_bar_and_detect_drinks
		         ]
	],
	...
	[% Go to living room and detect people without drinks  
		...
		type ==> recursive,
		embedded_dm ==> goto_living_room_and_detect_people_without_drinks(FinalStatus),
		arcs ==> [
