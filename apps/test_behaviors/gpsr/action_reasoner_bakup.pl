...
%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%
%introduce(person1,location1,person2,location2)
construct_commands(introduce(P1,Loc1,P2,Loc2),[
        say(['I will introduce', P1, 'to', P2],_),
	say(['I am going to the', Loc1],_),	       
	consult_kb(value_object_property, [Loc1,position], Point1, _),
	find(person,X,[Point1],[0.0,-20.0,20.0],[0.0,-15.0],detect_body_with_approach, _, _, false, false, false, _),
	say(['Hello', P1, 'please stay behind me and follow me to the', Loc2, 'I will introduce a friend'],_),
	consult_kb(value_object_property, [Loc2,position], Point2, _),
	find(person,Y,[Point2],[0.0,-20.0,20.0],[0.0,-15.0],detect_body_with_approach, _, _, false, false, false, _),
	say(['Hello ', P2, 'this ', P1],_),
	move([turn_precise=>(180.0)],_),
	say([P1, 'this', P2],_)
	]).
...
construct_commands(take(object(X), Status),[
	say(['I will search for the', X], _),
	consult_kb(change_object_property, [golem,found,X], _, _), 
	consult_kb(value_object_property, [golem,found], Obj_Name, _), 
	say(['Here is the',Obj_Name,'so i will take it'], _),
