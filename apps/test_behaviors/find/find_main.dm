...
[
    ...
    [  
      		...
      		%embedded_dm ==> find(person, X, [displace=>(0.32),turn=>(-36.0),displace=>(0.20)], [-30.0,30.0], [0.0,-15.0], recognize_body, Found_Persons, Remaining_Positions, false, false, false, Status),
                ...
                embedded_dm ==> find(object, X, [shelf_drinks, shelf_snacks], [0.0], [-30.0], object, FndObj, Remaining_Positions, false, false, false, Status),
		...
		%embedded_dm ==> find(object, drinks, [waiting_position,stove], [-20,20], [-30,0], category, FndObj, Remaining_Positions, false, false, false, Status),
		...
		arcs ==> [
        			success : [say('I found it')] => temp(FndObj),
    ...
    [
      id ==> temp([[Name,_,_,_,_,_,_,_,_]|_]),	
      type ==> neutral,
      arcs ==> [
                empty : [say(['I found ',Name])] => fs
               ]
    ],
