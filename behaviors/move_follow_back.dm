...
diag_mod(move_follow_back(Movements,Status),
[
	...
	[
		id ==> verify_case(coordinate,ListOfMovements),
      		type ==> neutral,
      		arcs ==> [
			 empty : [switcharm(0),tiltv(-30.0),set(last_tilt,-30.0),robotheight(1.10),set(last_height,1.10),switchpose('nav')] => go_to_point(ListOfMovements)
      			]
    	],	
	...
	[
		id ==> verify_case(label,ListOfLabels),
			 ...
			 empty : [switcharm(0),tiltv(-30.0),set(last_tilt,-30.0),robotheight(1.10),set(last_height,1.10),switchpose('nav')] => go_to_point( apply(from_labels_to_coordinates(L),[ListOfLabels]) )
      			]
    	],	
	...
	%Final situations  
    	...
    	[
      		id ==> success,
      		type ==> final,
		diag_mod ==> move_follow_back(_, ok)
    	],

    	[
      		id ==> error,
      		type ==> final,
		diag_mod ==> move_follow_back(_, navigation_error)
    	]
