...
consult_location_object(Object, KB, Answer):-
	object_relation_value(Object,in_location,KB,Answer),!.

consult_location_class(Class, KB, Answer):-
	class_relation_value(Class,in_location,KB,Answer),!.
...
consult_amount(Object, Place, KB, Answer):-
	...
	object_relation_value(Object,in_location,KB,Location),
	determine_amount(Location, Place, Amount, Answer),!.

consult_amount_objects(Place, KB, Answer):-
	relation_extension(in_location, KB, Elements),
...
consult_amount_category_place(Category, Place, KB, Answer):-
	class_relation_value(Category, in_location, KB, Location),
...
consult_LF([say('capital canada')], '>the capital of canada is ottawa'):-!.
consult_LF([say('canada anthem')], 'o canada'):-!.
consult_LF([say('what is sakura')], 'sakura is the japanese term for ornamental cherry blossom and its tree'):-!.
consult_LF([say('canada name')], 'the name canada comes from the iroquois word Kanata, meaning village or settlement'):-!.
...
% Questions for the german open
consult_LF([say('what is robotics')], 'the scientific study of robot'):-!.
consult_LF([say('who is considered as the father of industrial robot')], 'joseph engelberger'):-!.
consult_LF([say('who holds the patent for the first industrial robot')], 'george devol'):-!.
consult_LF([say('what are the three major components of a robot')], 'manipulator brain and  power supply'):-!.
consult_LF([say('which part controls the movement of robots hand')], 'the manipulator'):-!.
consult_LF([say('what is the purpose of a computer in a robot system')], 'as its controller'):-!.
consult_LF([say('what are the hardwares essential in a computer controlled robot')], 'memory cpu a d and d a converters'):-!.
consult_LF([say('give one example for a computer programming language that can be used for robot programming')], 'aml a manufacturing language'):-!.
consult_LF([say('what is flexible manufacturing system fms or computerized manufacturing system')], 'a combination of cad cam and robotics'):-!.
consult_LF([say('what is the major disadvantage of using a robot')], 'heavy investment'):-!.
consult_LF([say('the expert system was introduced in')], '1958'):-!.
consult_LF([say('the expert system was developed by which university')], 'stanford'):-!.
consult_LF([say('the first expert system was')], 'dendral'):-!.
consult_LF([say('in which field the expert system has application areas of ai')], 'artificial intelligence'):-!.
consult_LF([say('name the language used in expert system')], 'lisp and prolog'):-!.
consult_LF([say('name one of the most important parts in expert system')], 'the knowledge base'):-!.
consult_LF([say('which system was designed for diagnosis and therapy recommendation for infectious disease')], 'mycin'):-!.
consult_LF([say('dendral system is widely used by')], 'research chemists'):-!.
consult_LF([say('which system has been designed for solving mathematical problems')], 'macsyma'):-!.
consult_LF([say('which system has been designed to assist geologist in mineral exploration')], 'prospector'):-!.
consult_LF([say('what is artificial intelligence')], 'artificial intelligence is a branch of computer science concerned with the study and creation of systems that exhibit some form of human intelligence'):-!.
consult_LF([say('what is the importance of ai')], 'human intelligence have certain limit in speed and accuracy it is interrupted due to the lack of presence of mind mood etc bu ai systems have their own superb abilities'):-!.
consult_LF([say('who is the father of artificial intelligence')], 'alan turing'):-!.
consult_LF([say('which is the first test programming language')], 'i p l'):-!.
consult_LF([say('the beginning of artificial intelligence in')], '1958'):-!.
consult_LF([say('what are the languages used for artificial intelligence programming')], '1 lisp 2 prolog 3 small talk and actor'):-!.
consult_LF([say('lisp is')], 'list programming language'):-!.
consult_LF([say('prolog is')], 'logic programming language'):-!.
consult_LF([say('small talk and actor are')], 'object oriented programming language'):-!.
consult_LF([say('what are the branches of artificial intelligence')], '1 expert system 2 natural language system 3 perception system'):-!.
consult_LF([say('who invented compact disc')], 'james t russel'):-!.
consult_LF([say('which day is celebrated as world computer literacy day')], 'december 2'):-!.
consult_LF([say('who invented java')], 'james a gosling'):-!.
consult_LF([say('longhorn was the code name of ')], 'windows vista'):-!.
consult_LF([say('who is known as the human computer of india')], 'shakunthala devi'):-!.
consult_LF([say('what is mean by liveware')], 'people who work with the computer'):-!.
consult_LF([say('which computer engineer got nobel prize for literature in 2003')], 'jm coetzee'):-!.
consult_LF([say('weaving the web was written by')], 'tim burners lee'):-!.
consult_LF([say('what is beta test')], 'trial test of a computer or software before the commercial launch'):-!.
consult_LF([say('do no evil is tag line of')], 'google'):-!.
consult_LF([say('first indian cinema released through internet is')], 'vivah'):-!.
consult_LF([say('rediffcom was founded by')], 'ajith balakrishnan and manish agarwal'):-!.
consult_LF([say('what is the extension of pdf')], 'portable document format'):-!.
consult_LF([say('mows is a type of mouse for')], 'people physically handicapped people'):-!.
consult_LF([say('expand rdbms')], 'relational data base management system'):-!.
consult_LF([say('difference engine was developed by')], 'charles babbage'):-!.
consult_LF([say('orkut dot com is now owned by')], 'google'):-!.
consult_LF([say('worlds first microprocessor is')], 'intel 4004'):-!.
consult_LF([say('what is sql')], 'structured query language'):-!.
consult_LF([say('what is the expansion of cobol')], 'common business oriented language'):-!.
consult_LF([say('what is the expansion of sms')], 'short message service'):-!.
consult_LF([say('which it companys nickname is the big blue')], 'i b m'):-!.
consult_LF([say('what is the full form of ieee')], 'institute of electric and electronic engineers'):-!.
consult_LF([say('who developed cobol')], 'grace murry hopper'):-!.
consult_LF([say('email was developed by')], 'raymond samuel tomlinson ray tomlinson'):-!.
consult_LF([say('green dam is')], 'a web filter'):-!.
consult_LF([say('what is the expanded form of cmos')], 'complementary metal oxide semoconductor'):-!.
consult_LF([say('who is netizen')], 'net citizen citizen who uses internet'):-!.
consult_LF([say('what is scareware')], 'fake antivirus softwares'):-!.
consult_LF([say('when was the first smart phone launched')], '1992 i b m simon'):-!.
